...
var require_base_convert_int_array = __commonJS({
  "node_modules/base-convert-int-array/index.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = baseConvertIntArray;
  }
});

// node_modules/ksuid/base62.js
var require_base62 = __commonJS({
  "node_modules/ksuid/base62.js"(exports2) {
    "use strict";
    var baseConvertIntArray = require_base_convert_int_array();
    var CHARS = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    function encode(buffer, fixedLength) {
      return baseConvertIntArray(buffer, { from: 256, to: 62, fixedLength }).map((value) => CHARS[value]).join("");
    }
...
var require_ksuid = __commonJS({
  "node_modules/ksuid/index.js"(exports2, module2) {
    "use strict";
    var { randomBytes } = require("crypto");
    var { inspect: { custom: customInspectSymbol }, promisify } = require("util");
    var base62 = require_base62();
...
`.trim().replace(/(\n|\s)+/g, " ").replace(/\.000Z/g, "Z");
    ...
    Object.defineProperty(KSUID2.prototype, Symbol.toStringTag, { value: "KSUID" });
    Object.defineProperty(KSUID2, "MAX_STRING_ENCODED", { value: "aWgEPTl1tmebfsQzFP4bxwgy80V" });
    Object.defineProperty(KSUID2, "MIN_STRING_ENCODED", { value: "000000000000000000000000000" });
    module2.exports = KSUID2;
  }
});

// node_modules/@aws-appsync/utils/lib/resolver-return-types.js
var require_resolver_return_types = __commonJS({
  "node_modules/@aws-appsync/utils/lib/resolver-return-types.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
  }
});

// node_modules/@aws-appsync/utils/lib/index.js
var require_lib5 = __commonJS({
  "node_modules/@aws-appsync/utils/lib/index.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.runtime = exports2.extensions = exports2.util = void 0;
    __exportStar(require_resolver_return_types(), exports2);
    var util2 = {};
    exports2.util = util2;
    var extensions = {};
...
// lib/lambda-fns/booking/app.ts
var import_logger = __toESM(require_lib2());
var import_tracer = __toESM(require_lib4());

// lib/lambda-fns/booking/createApartmentBooking.ts
var import_aws_sdk = require("aws-sdk");

// lib/utils/index.ts
var KSUID = require_ksuid();
var uuid = () => {
  return KSUID.randomSync().string;
};

// src/lib/helpers.ts
var import_utils = __toESM(require_lib5());
function createItem(item) {
  return {
    ...item,
    createdAt: import_utils.util.time.nowISO8601(),
    updatedAt: import_utils.util.time.nowISO8601()
  };
}

// lib/lambda-fns/booking/createApartmentBooking.ts
async function createApartmentBooking(appsyncInput, logger2) {
  ...
  const id = uuid();
  const sqs = new import_aws_sdk.SQS();
  console.log(appsyncInput.input);
  if (BOOKING_QUEUE_URL === void 0) {
    logger2.error(`Couldn't get the queue url name`);
  ...
  if (tableName === void 0) {
    logger2.error(`Couldn't get the table name`);
    tableName = "AcmsDynamoDBTable";
  }
  logger2.info(`create booking input info", ${JSON.stringify(bookingInput)}`);
  const params = {
    TableName: tableName,
  ...
  logger2.info(`sqs pre message ${JSON.stringify(bookingInput)}`);
  logger2.info(`sqs  queue url ${BOOKING_QUEUE_URL}`);
  const sqsParams = {
  ...
  try {
    ...
    logger2.info(`an error occured while sending message to sqs", ${error}`);
    throw Error(`an error occured while sending message to sqs", ${error}`);
  }
}
var createApartmentBooking_default = createApartmentBooking;
...
exports.handler = async (event, context) => {
  ...
  switch (event.info.fieldName) {
    case "createApartmentBooking":
      return await createApartmentBooking_default(event.arguments, logger);
    default:
      return null;
  }
};
